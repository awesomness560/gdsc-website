// changes made (to better reflect the figma design):
// added arrow prop to display an arrow icon left of the button text if set true
// increased rounding from md to 3xl
// increased butotn padding
...
const buttonVariants = cva(
  ...
  {
    variants: { // no clue what some of these variants are but I added a blue one for the navbar
      variant: {
        default:
          "bg-gdscyellow text-primary-foreground shadow-xs hover:bg-gdscyellow/90",
        blue:
          "bg-gdscblue text-secondary-foreground rounded-xl shadow-xs hover:bg-gdscblue/90",
          destructive:
      ...
      size: {
        default: "h-9 px-5 py-5 has-[>svg]:px-5",
